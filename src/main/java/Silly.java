...
public class Silly implements Comparable<Silly> {
     ...
     *
     * @param string1 string for first part of the name
     * @param string2 string for second part of the name
     */
    ...
    public static void main(String[] args) {
         ...
         */
        Silly version1 = new Silly("single str name");
        Silly version2 = new Silly(5);
        Silly version3 = new Silly("first", "second");

        System.out.println("Silly 1: " + version1);
        System.out.println("Silly 2: " + version2);
        System.out.println("Silly 3: " + version3);
    ...
    public int compareTo(Silly other) {
         ...
         * .length() method.
         */
        int sNameLength = this.name.length();
        int oNameLength = other.name.length();

        if (sNameLength == oNameLength) {
            return 0;
        } else if (sNameLength > oNameLength) {
            return 1;
        } else {
            return -1;
        }
